...
Page({
  ...
  createCard: function () {
    ...
    i.fillStyle = "#000";
    const id = this.drawText(i, time, 30, 170, 60, 250);
    // 内容
    i.font = "normal 16px 黑体";
    this.drawText(i, value, 60, 170, 60, 250);
    // 图片
    var width = 110;
    var height = 110;
    var circle = {
